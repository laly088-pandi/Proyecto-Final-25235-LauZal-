...
import CartContext from "./CartContext"; // IMPORTANTE
...
const CrudProductos = () => {
    ...
    const { agregarAlCarrito } = useContext(CartContext); // <- PARA EL CARRITO
    ...
    const eliminarProducto = (id) => {
        if (!window.confirm("Seguro Que Deseas Realizar Esta Accion?")) return;
